/*In this version, Im using a a double as a return value for the Trap function instead of writing 
 to a memory location pointed by a pointer variable.*/
#include <stdio.h>
#include <stdlib.h>
#include <omp.h>
...
int main(int argc, char* argv[]){
	...
	double global_sum = 0.0;//a variable with a shared scope; 

#	pragma omp parallel num_threads(thread_count)
	{
		double my_result = Trap(a, b, n);//private to the thread
