...
void Trap(double a, double d, int n , double* global_result_p); /*thread function*/
...
int main(int argc, char* argv[]){
	...
	double global_sum;//a variable with a shared scope; 
...
void Trap(double a, double b, int n, double* global_sum_p){
